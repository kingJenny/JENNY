...
public class TingBoardVO {
   ...
   //*************************************************
   /*MultipartFile file;   // write.jsp 뿉  뙆 씪泥⑤  떆 name="file"怨   룞 씪 븳 蹂  닔紐 
   ...
   public void setFile(MultipartFile file) {
      ...
      if(! file.isEmpty()){
         ...
         //***********************************************
         //  빐 떦 寃쎈줈濡  蹂 寃 
         File f = new File("C:\\Users\\User\\Documents\\카카오톡 받은 파일\\ting_0107_추가\\src\\main\\webapp\\resources\\upload\\"+fname);
