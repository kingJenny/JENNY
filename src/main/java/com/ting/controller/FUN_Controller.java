...
public class FUN_Controller {
	...
	@RequestMapping("/no/selectmychar")
	@ResponseBody List<Fun_my_character_VO> select_data(HttpServletRequest request, HttpSession session, 
																						Fun_my_character_VO fvo,@RequestBody Fun_my_character_VO vo){		
		//vo.setClientIdx((int)session.getAttribute("clientIdx"));
		List<Fun_my_character_VO> rs= fun_Mbtitest_0_Service.selectlist_Fun_mychar(vo);	
		System.out.println("-------------------------------------------------------------");
		System.out.println(rs.size());
		System.out.println("-------------------------------------------------------------");
		System.out.println("fun_Mbtitest_0_Service2");
		return rs;	
	}
