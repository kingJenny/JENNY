...
.footer {
  ...
  color: white;
	...
	<center>
<h1><i class="fas fa-bullhorn"></i>신고가 완료되었습니다.<i class="fas fa-bullhorn"></i></h1><br>
<h2>신고 내역 검토 후 팅투데이 이용 규칙 위반 사실이</h2><br>
<h2>규정에 맞는 조치가 이루어질 예정입니다.</h2><br>
<h2>건전한 팅투데이 운영에 참여해주셔서 감사합니다.</h2>
