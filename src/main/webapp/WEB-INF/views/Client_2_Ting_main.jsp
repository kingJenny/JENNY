		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">★오늘의 Jenny★</h2>
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
					
					<h1 class="to-animate">${sessionScope.nickname}님은 <span style="color:red;">${heartCnt}</span>개의 별을 가지고 있어요!</h1>
					<h3 class="to-animate">좋아요를 보낼 때 한 개의 하트가 소진되며,</h3>
					<h3 class="to-animate">매일 2시 20분 Jenny 추천과 함께 별 한 개가 충전돼요!</h3>
					<h1 class="to-animate">선택을 할수록 원하는 추천 알고리즘이 개선되어, </h1>
			...
			<c:forEach items="${idealRecommendation}" var="idealRecommendation">
				<div class="col-md-4">
						...
						<h2>유사도: ${idealRecommendation.similarity}%</h2>	
						 </c:when>
						 </c:choose>
