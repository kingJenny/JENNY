...
<section id="fh5co-testimonials" data-section="testimonials">
   ...
   <div class="row">
		...
		<div class="col-md-05 section-heading text-center">
			<h1>당신의 매력포인트를 알려주세요!</h1>
		</div>
		<div class="col-md-offset-2 col-md-8 options__ouvgd text-center">

			<c:forEach items="${charmingPointList}" var="list">
			<div class="ui checkbox" style="width:300px; height:50px; font-size:30px;">
					<input type="checkbox" name="clientInterest" value='${list.charmingPointIdx}' style="width:150px; height:50px; font-size:30px;"> 
   ...
   $(document).ready(function() {
	  ...
	  $('.sum').click(function(){
		  ...
		  console.log(arr);
		  location.href='insertClientCharmingPoint?arr='+arr;
	  })
   });
   </script>
