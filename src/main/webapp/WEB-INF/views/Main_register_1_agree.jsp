...
<!DOCTYPE html>
 ...
 <form class="ui large form">
	  ...
	  <button class="compact ui  button" style = "float:right;margin:0;">메인으로</button><br><br><br>
	   ...
	   <div class="field">
            <input type="checkbox" name="agree_choice_1" >&nbsp;<span style="color:#8d08ae;">동의합니다. </span> <span style="color:blue;">(선택)</span>
 ...
 단체의 회원관리 담당직원이 고객의 요청 시 동의 후, 회원 내역을 조회, 이용안내 서비스 등의 업무 전달을 위한 서비스 지원 업무에 필요한 개인 정보를 지원한다.</div>
	   ...
	   <div class="field">
		    <div class="ui fluid large purple submit button" id="submit_func" >다음 >></div>
	   </div>
		<!--===============submit은 함수사용=================-->
