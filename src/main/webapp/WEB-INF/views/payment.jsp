		...
		<div class="container">
  			<div class="text-wrap" style="top:100px; background-color: white;" align="center">	
  				<div class="row row-bottom-padded-md">	
					...
					<div class="col-md-6 to-animate" style="width: 1000px; top: 100px;padding-left: 200px;" align="center">					
						<h3><font size="12px" style="font-variant: bold;">결제 내용 확인</font></h3>
						
							<table class="w3-table-all notranslate" style="width: 800px;height: 400px;">							
				              <tbody>
				                <tr>
				                  <th style="border: 2px solid #52D3AA;"><h4 align="center">결제 상품명</h4></th>
				                  <th style="border: 2px solid #52D3AA;width: 600px; height : 50px;padding:10px;"><h3 align="center">
				                  <div class="form-group "><h3 id="name" class="form-control">상품명</h3></div></h3></th>
				                </tr>
				                
				                <tr>
				                  <th style="border: 2px solid #52D3AA;"><h4 align="center">결제 상품가격</h4></th>
				                  <th style="border: 2px solid #52D3AA;width: 600px; height : 50px;padding:10px;"><h3 align="center">
									<div class="form-group "><h3 id="email" class="form-control">결제 상품 가격</h3></div></h3></th>
				                </tr>
				                <tr>
				                  <th style="border: 2px solid #52D3AA;"><h4 align="center">결제 수단선택</h4></th>				                  
				                  <th style="border: 2px solid #52D3AA;width: 600px; height : 50px;padding:10px;">		
				                  													
									<div class="form-group ">
										<h3 id="phone" class="form-control">
										<select name="addr">결제 수단 선택</h3>	
											<option value="">-결제수단 선택-</option>
												<option value="계좌이체">계좌이체</option>
												<option value="무통장입금">무통장입금</option>
												<option value="KaKaoPay">KaKaoPay</option>
												<option value="체크카드 결제">체크카드 결제</option>
												<option value="신용카드 결제">신용카드 결제</option>
												<option value="Toss 결제">Toss 결제</option>
										</select>							
									</div>														
				                  </th>		                 			                  
				                </tr>				                
						...
						<div class="form-group" style="padding: 50px;">
							<input class="btn btn-primary btn-lg" type="button" value="결제 하기" onclick="showPopup();" />
							<a href="index.html"><input class="btn btn-primary btn-lg" value="취소 하기" type="submit"></a>				
						</div>						  
					</div>	
					</div>			
				</div>
